...
def arg_parse():
	...
	parser.add_argument('--output_params', action='store', dest='model_param_path',help='file path to pickled model parameters',required=True)
...
def main(input_file, model_path):
    ...
    print 'Reading in saved model parameters...'
